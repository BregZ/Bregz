...
class XQMenuTitleModel: NSObject {
    ...
    //将字典 转化为对象
    class func menuTitleWithDict(dict : NSDictionary ) -> XQMenuTitleModel{
        
        return XQMenuTitleModel(dict: dict)
    ...
    init(dict : NSDictionary) {
        ...
        if self.menuContents != nil {
            ...
            for dtic in self.menuContents! {
                let menuContent : XQMenuContentModel = XQMenuContentModel.menuContentWithDict(dtic as! NSDictionary)
